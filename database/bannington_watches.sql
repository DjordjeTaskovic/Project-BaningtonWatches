...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2023 at 02:12 PM
...
INSERT INTO `anketa` (`id_anketa`, `ime`, `poruka`, `broj_zvezda`) VALUES
(1, 'Nikoal Spasojevic', 'povracaj Novca', 0),
(2, ':ime', ':poruka', 0),
(3, 'Nikola Spasic', 'aaaaaaaaaaaa', 0),
(4, 'Menko Ris', 'Hteo bih da narucim novi proizvod.', 0),
(5, 'Petar Strugar', 'aaaaaaaaaa', 0),
(6, 'Petar', 'aaaaaa', 0),
(7, 'jhon4444', 'fsdfsdfsd', 3);
...
CREATE TABLE `baner` (
  ...
  `banneropis` varchar(25) NOT NULL,
...
(5, 'nikola', 'nikola@gmai.ocm', '0644823145', 'nikola');
...
(5, 'Nathaniel Baker', 'nikola@gmail.com', 'Nikola 11', '8c7029ffac2fc0821cbd6d6bc21c3ddd', '2023-10-19', '2023-10-19 08:43:12', 2),
(6, 'jhon4444', 'jhon444@gmail.com', 'sfasfasfas', 'e926ff4153296c43534d08874bf969fe', '2023-10-19', '2023-10-19 09:17:02', 2);
...
--
ALTER TABLE `anketa`
  MODIFY `id_anketa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
